...
#ifndef COLDSPACE_MAP_H
#define COLDSPACE_MAP_H
...
//Enumerates basic dimensions of tiles and sheets.
...
struct Tile{
    ...
    // Other flags  are unique to each tile.
};
