...
#ifndef COLDSPACE_SOUNDMANAGER_H
#define COLDSPACE_SOUNDMANAGER_H
...
using SoundContainer = std::unordered_map<SoundID, std::pair<SoundInfo, sf::Sound*>, EnumClassHash>;
using Sounds = std::unordered_map<StateType, SoundContainer, EnumClassHash>;
using RecycledSounds = std::vector<std::pair<std::pair<SoundID, std::string>, sf::Sound*>>;
using MusicContainer = std::unordered_map<StateType, std::pair<SoundInfo, sf::Music*>, EnumClassHash>;
...
#endif //COLDSPACE_SOUNDMANAGER_H
