...
#ifndef COLDSPACE_GUI_MANAGER_H
#define COLDSPACE_GUI_MANAGER_H
...
using GUI_Interfaces = std::map<std::string, GUI_Interface*>; //changed into a map from unordered map
using GUI_Container = std::unordered_map<StateType, GUI_Interfaces,EnumClassHash>;
using GUI_Events = std::unordered_map<StateType, std::vector<GUI_Event>,EnumClassHash>;
using GUI_Factory = std::unordered_map<GUI_ElementType, std::function<GUI_Element*(GUI_Interface*)>,EnumClassHash>;
